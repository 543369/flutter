// Opt-in: PETCARE_QA_FONT=/path/to/CJK.ttf flutter test tool/benefits_visual_qa_test.dart
import 'dart:io';
...
import '../test/benefits_test.dart' show BenefitsApi;
import '../test/widget_test.dart' show FakeReminders, tapVisible;

void main() {
  testWidgets('capture family benefits and annual report', (tester) async {
    ...
    final api = BenefitsApi()..token = 'visual-test';
    ...
    Future<void> capture(String name) async {
      ...
      await tester.runAsync(() async {
        ...
        final dir = Directory(Platform.environment['PETCARE_QA_OUTPUT'] ??
            '/private/tmp/petcare-benefits-qa');
